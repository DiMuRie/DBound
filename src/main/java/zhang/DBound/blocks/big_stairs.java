...
public class big_stairs extends Block {
	...
	public big_stairs(Material material) {
		super(material);
		this.setUnlocalizedName("big_stairs");
...
//TODO do the colision/bounding box,create item model,fix name,set blockstate
